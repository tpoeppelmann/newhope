...
# asm 1: vmulpd <r0=reg256#3,<qinv=reg256#2,>c=reg256#8
# asm 2: vmulpd <r0=%ymm2,<qinv=%ymm1,>c=%ymm7
...
# asm 1: vfnmadd231pd <c=reg256#8,<q=reg256#1,<r0=reg256#3
# asm 2: vfnmadd231pd <c=%ymm7,<q=%ymm0,<r0=%ymm2
...
# asm 1: vmulpd <r1=reg256#4,<qinv=reg256#2,>c=reg256#9
# asm 2: vmulpd <r1=%ymm3,<qinv=%ymm1,>c=%ymm8
vmulpd %ymm3,%ymm1,%ymm8

# qhasm: 4x c = floor(c)
# asm 1: vroundpd $9,<c=reg256#9,>c=reg256#9
# asm 2: vroundpd $9,<c=%ymm8,>c=%ymm8
vroundpd $9,%ymm8,%ymm8

# qhasm: 4x r1 approx-= c * q
# asm 1: vfnmadd231pd <c=reg256#9,<q=reg256#1,<r1=reg256#4
# asm 2: vfnmadd231pd <c=%ymm8,<q=%ymm0,<r1=%ymm3
vfnmadd231pd %ymm8,%ymm0,%ymm3
...
# asm 1: vmulpd <r2=reg256#5,<qinv=reg256#2,>c=reg256#10
# asm 2: vmulpd <r2=%ymm4,<qinv=%ymm1,>c=%ymm9
...
# asm 1: vfnmadd231pd <c=reg256#10,<q=reg256#1,<r2=reg256#5
# asm 2: vfnmadd231pd <c=%ymm9,<q=%ymm0,<r2=%ymm4
...
# asm 1: vmulpd <r3=reg256#6,<qinv=reg256#2,>c=reg256#7
# asm 2: vmulpd <r3=%ymm5,<qinv=%ymm1,>c=%ymm6
...
# asm 1: vfnmadd231pd <c=reg256#7,<q=reg256#1,<r3=reg256#6
# asm 2: vfnmadd231pd <c=%ymm6,<q=%ymm0,<r3=%ymm5
...
# qhasm: 4x c = approx r3 * qinv
# asm 1: vmulpd <r3=reg256#4,<qinv=reg256#2,>c=reg256#5
# asm 2: vmulpd <r3=%ymm3,<qinv=%ymm1,>c=%ymm4
vmulpd %ymm3,%ymm1,%ymm4

# qhasm: 4x c = floor(c)
# asm 1: vroundpd $9,<c=reg256#5,>c=reg256#5
# asm 2: vroundpd $9,<c=%ymm4,>c=%ymm4
vroundpd $9,%ymm4,%ymm4

# qhasm: 4x r3 approx-= c * q
# asm 1: vfnmadd231pd <c=reg256#5,<q=reg256#1,<r3=reg256#4
# asm 2: vfnmadd231pd <c=%ymm4,<q=%ymm0,<r3=%ymm3
vfnmadd231pd %ymm4,%ymm0,%ymm3
...
# qhasm: 4x c = approx r1 * qinv
# asm 1: vmulpd <r1=reg256#3,<qinv=reg256#2,>c=reg256#4
# asm 2: vmulpd <r1=%ymm2,<qinv=%ymm1,>c=%ymm3
...
# qhasm: 4x r1 approx-= c * q
# asm 1: vfnmadd231pd <c=reg256#4,<q=reg256#1,<r1=reg256#3
# asm 2: vfnmadd231pd <c=%ymm3,<q=%ymm0,<r1=%ymm2
...
# qhasm: 4x c = approx a1 * qinv
# asm 1: vmulpd <a1=reg256#7,<qinv=reg256#2,>c=reg256#8
# asm 2: vmulpd <a1=%ymm6,<qinv=%ymm1,>c=%ymm7
...
# qhasm: 4x a1 approx-= c * q
# asm 1: vfnmadd231pd <c=reg256#8,<q=reg256#1,<a1=reg256#7
# asm 2: vfnmadd231pd <c=%ymm7,<q=%ymm0,<a1=%ymm6
vfnmadd231pd %ymm7,%ymm0,%ymm6
...
# asm 1: movupd <t0=reg256#4dq,0(<ap=int64#1)
# asm 2: movupd <t0=%xmm3,0(<ap=%rdi)
movupd %xmm3,0(%rdi)

# qhasm: mem128[ap + 512] = t1
# asm 1: movupd <t1=reg256#8dq,512(<ap=int64#1)
# asm 2: movupd <t1=%xmm7,512(<ap=%rdi)
movupd %xmm7,512(%rdi)

# qhasm: mem128[ap + 1024] = t2
# asm 1: movupd <t2=reg256#9dq,1024(<ap=int64#1)
# asm 2: movupd <t2=%xmm8,1024(<ap=%rdi)
movupd %xmm8,1024(%rdi)

# qhasm: mem128[ap + 1536] = t3
# asm 1: movupd <t3=reg256#10dq,1536(<ap=int64#1)
# asm 2: movupd <t3=%xmm9,1536(<ap=%rdi)
movupd %xmm9,1536(%rdi)
...
# asm 1: movupd <t0=reg256#4dq,2048(<ap=int64#1)
# asm 2: movupd <t0=%xmm3,2048(<ap=%rdi)
movupd %xmm3,2048(%rdi)

# qhasm: mem128[ap + 2560] = t1
# asm 1: movupd <t1=reg256#5dq,2560(<ap=int64#1)
# asm 2: movupd <t1=%xmm4,2560(<ap=%rdi)
movupd %xmm4,2560(%rdi)

# qhasm: mem128[ap + 3072] = t2
# asm 1: movupd <t2=reg256#6dq,3072(<ap=int64#1)
# asm 2: movupd <t2=%xmm5,3072(<ap=%rdi)
movupd %xmm5,3072(%rdi)

# qhasm: mem128[ap + 3584] = t3
# asm 1: movupd <t3=reg256#3dq,3584(<ap=int64#1)
# asm 2: movupd <t3=%xmm2,3584(<ap=%rdi)
movupd %xmm2,3584(%rdi)
